...
> 📌 **导航**：本文是 **Linux 命令速查手册** 词条，属于 os 术语集。相关枢纽：[[Shell 脚本详解]]、[[操作系统基础术语]]、[[操作系统核心]]、[[进程管理详解]]。

## 概述

**一句话定义：** 本文按功能分类汇总最常用的 Linux 命令与典型用法（文件与目录、文本处理、权限、进程、磁盘、网络、压缩），作为日常运维与开发的速查参考。

> 多义说明：进程与服务的深入实操见 [[进程管理详解]]；Shell 脚本编写见 [[Shell 脚本详解]] 与 [[Shell脚本编程]]；命令背后的概念见 [[操作系统核心]]。
...
[[进程管理详解]]、[[Shell 脚本详解]]、[[Shell脚本编程]]、[[操作系统核心]]、[[文件系统]]

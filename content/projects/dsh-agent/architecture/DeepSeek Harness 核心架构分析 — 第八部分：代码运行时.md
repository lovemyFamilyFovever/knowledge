...
DeepSeek Harness 核心架构分析 — 第八部分：代码运行时
...
全局标识符必须匹配
[A-Za-z_][A-Za-z0-9_]*
，且不能是 ECMAScript ∪ Python 的保留字联合集。一个在 TypeScript 后端有效的命名空间列表在 Python 后端也有效。
35. Code Mode 集成
模型只能调用
run_code
工具
